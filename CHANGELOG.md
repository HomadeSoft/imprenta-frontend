...
- Deleted the copyright comments from all files, we only need to keep them inside our Nuevo.js and index.html
...
- Droped `src/components/Nuevo.js`, and changed all the imports to separate ones
